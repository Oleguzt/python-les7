...
vowel_count = lambda s: sum(1 for i in s if i in 'а')

def syllable_count(rhythm):
    return set(map(vowel_count, list(map(str, rhythm.split()))))

rhythm = 'пара-ра-рам рам-пам-папам па-ра-па-да'
if len(syllable_count(rhythm))>1:
    print('Пам парам')
else:
    print('Парам пам-пам')